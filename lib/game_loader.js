...
function loadImageCache() {
    ...
    backgroundImage.id = "table_top";
    backgroundImage.src = `img/table_top.png`;
    backgroundImage.onload =  () => {
        gCardImageCacheObj[backgroundImage.id] = backgroundImage;
...
function loadAllGameComponents() {
    ...
    console.log(`loading all game components...`);
    loadImageCache();
